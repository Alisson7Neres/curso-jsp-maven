...
import com.jsp.service.ReportUtil;
...
public class ServletUsuarioController extends ServletGenericUtil {
		...
		try {
			...
			if (acao != null && !acao.isEmpty() && acao.equalsIgnoreCase("deletar")) {
				...
				response.addHeader("totalPagina", ""
						+ daoUsuarioRepository.consultarTotalPaginaPaginacao(nomeBusca, super.getUserLogado(request)));
				...
				List<ModelLogin> dadosJsonUser = daoUsuarioRepository.consultarOffset(nomeBusca,
				...
				if (dataInicial == null || dataInicial.isEmpty() && dataFinal == null || dataFinal.isEmpty()) {
					...
					request.setAttribute("listaUser", daoUsuarioRepository.listarRel(super.getUserLogado(request)));

				} else {
					request.setAttribute("listaUser",
							daoUsuarioRepository.listarRel(super.getUserLogado(request), dataInicial, dataFinal));
				}
				...
				request.getRequestDispatcher("principal/reluser.jsp").forward(request, response);
					...
					|| acao.equalsIgnoreCase("imprimirRelatoriorExcel")) {
				...
				if (dataInicial == null || dataInicial.isEmpty() && dataFinal == null || dataFinal.isEmpty()) {
					...
					modelLogin = daoUsuarioRepository.listarRel(super.getUserLogado(request));

				} else {
					modelLogin = daoUsuarioRepository.listarRel(super.getUserLogado(request), dataInicial, dataFinal);
				...
				if (acao.equalsIgnoreCase("imprimirRelatorioPDF")) {
					relatorio = new ReportUtil().gerarRelatorio(modelLogin, "Invoice", params,
							request.getServletContext());
					extensao = "pdf";
				} else if (acao.equalsIgnoreCase("imprimirRelatoriorExcel")) {
					relatorio = new ReportUtil().gerarRelatorioExcel(modelLogin, "Invoice", params,
							request.getServletContext());
					extensao = "xls";
				}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// Date.valueOf(new SimpleDateFormat("yyyy-mm-dd").format(new
